...
print("Calculando CDF sequencialmente: ")
start_time_seq = time.perf_counter()
cdf_values = [compute_product_cdf_1d(z, muX, sigmaX, muY, sigmaY) for z in z_range]
end_time_seq = time.perf_counter()
elapsed_time_seq = end_time_seq - start_time_seq
print(f"Tempo de execução (Sequencial): {elapsed_time_seq:.4f} segundos")
