...
def compute_cdf_point(z):
    return compute_product_cdf_1d(z, muX, sigmaX, muY, sigmaY)


if __name__ == "__main__":
    
    cdf_integration = Parallel(n_jobs=-1, verbose=5)(
        delayed(compute_cdf_point)(z) for z in z_range
    )

    # CDF empírica (vetorizada, sem loop)
